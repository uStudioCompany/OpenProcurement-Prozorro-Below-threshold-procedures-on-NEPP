...
<div class="item no_border">
    ...
    <div class="row one-row-style">
        ...
        <div class="col-md-6">
            ...
            <b>
                <i>
                    <?= Html::encode($item->description_en) ?>
                </i>
            </b>
        </div>
    </div>
    ...
    <div class="row one-row-style">
        <div class="col-md-3">  <?= $item->deliveryDate->getAttributeLabel('startDate') ?></div>
        <div class="col-md-6">
            <b>
                <i tid="items.deliveryDate.startDate">
                    <?= $item->deliveryDate->startDate ? Html::encode($item->deliveryDate->startDate) : '' ?>
                </i>
            </b>
        </div>
    </div>
