    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-search">
                <input id="search" class="form-control" type="text" placeholder="<?=Yii::t('app','Пошук по назвi')?>">
                <input id="search_code" class="form-control" type="text" placeholder="<?=Yii::t('app','Пошук по коду')?>">
            </div>
