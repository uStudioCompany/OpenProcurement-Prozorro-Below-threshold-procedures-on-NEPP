...
//    }
    ...
    {
        return [
            [['startDate'], 'required','whenClient' => 'function (attribute, value) { return $(attribute.input).is(":visible"); }', 'except' => 'limitedavards','message'=>'Будь ласка, вкажіть дату початку перiоду, коли подаються пропозицiї'],
