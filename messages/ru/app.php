...
return [
    ...
    'Інформація по тендеру'=>'[RU]Інформація по тендеру',
    'Hello'=>'[RU]Вітаємо',
    'tender_auction_info_buyer'=>'[RU]Аукціон до вашого тендеру відбудеться сьогодні {date} о {time}, посилання на аукціон можна отримати на сторинці тендеру: ',
    'tender_auction_info_seller'=>'[RU]Сьогодні{date} о {time}, відбудеться аукціон до тендеру в якому ви взяли участь, посилання на аукціон можена отримати на сторінці тендеру: ',
    'need_auth'=>'[RU]на сайті попрібно авторізуватися.',
