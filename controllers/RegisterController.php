...
class RegisterController extends Controller
{
    ...
    public function actionConfirm()
    {
        ...
        if (!empty($user)) {
            ...
            echo Yii::t('app', 'Нет такого токена');
        }
    ...
    public function actionGetcountrysheme(){
        ...
        if (Yii::$app->request->isAjax) {
            ...
            $html = '<option value="">' . Yii::t('app', 'Choose the country of registration') . '</option>';
            if ($res) {
                foreach ($res as $k => $v) {
    ...
    public function actionGetcountryregion(){
        ...
        if (Yii::$app->request->isAjax) {
            ...
            $html = '<option value="">' . Yii::t('app', 'Select Region/Province') . '</option>';
            if ($res) {
                foreach ($res as $k => $v) {
    ...
    public function actionGetshemetype(){
        ...
        if (Yii::$app->request->isAjax) {
            ...
            $html = '<option value="">' . Yii::t('app', 'Select Property form') . '</option>';
            if ($res) {
                foreach ($res as $k => $v) {
